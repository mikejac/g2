...
#ifndef mjShield_pinout_h
#define mjShield_pinout_h
...
//    pin_number kZ_EnablePinNumber               =  -1;
    ...
    pin_number kGRBL_ResetPinNumber             =  54;	// A0
    pin_number kGRBL_FeedHoldPinNumber          =  55;	// A1
    pin_number kGRBL_CycleStartPinNumber        =  56;	// A2
